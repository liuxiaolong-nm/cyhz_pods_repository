...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.subspec 'popview' do |ss|
        ss.source_files = 'cyhz_component_utils/Classes/popview/**/*'
        ss.public_header_files = 'cyhz_component_utils/Classes/popview/**/*.h'
    end
   
 s.subspec 'net' do |ss|
       ss.source_files = 'cyhz_component_utils/Classes/net/**/*'
       ss.public_header_files = 'cyhz_component_utils/Classes/net/**/*.h'
       ss.dependency 'cyhz_component_utils/popview'
   end
